...
class StubApiService implements ApiService {
  ...
  Future<List<Map<String, dynamic>>> fetchPages(String userId) async {
    ...
    final pages = _pages.values.where((p) {
      final sameOwner = (p['userId'] == userId || p['userId'] == null);
      final isTeamPage =
          (p['teamSpaceId'] != null && (p['teamSpaceId'] as String).isNotEmpty);
      return sameOwner || isTeamPage;
    }).toList();
